...
async function initAssignmentHub() {
    ...
    studentForm.addEventListener('submit', async function(e) {
        ...
        // Update Canvas quiz link (replace with actual Canvas quiz URL)
        canvasLink.href = `https://your-canvas-instance.instructure.com/courses/your-course-id/quizzes/your-quiz-id`;
    });
}
